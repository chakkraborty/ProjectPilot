        ...
        <div className="display-flex">
          ...
          <div className="text-color-grey right-panel-wrapper">
            ...
            <div className="project-page-lower-wrapper">
              ...
              <div className="text-color-grey kanban-board-wrapper">
                <div className="kanban-board-title kanban-title-yellow">
                  <p className="padding-10px font-size-15px">IN PROGRESS</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
                ...
                {tasks.map((p) => {
                  if (p.status === "inprogress") {
                    return (
                      <div className="task-card" key={p._id}>
                        <div className="task-card-top-wrapper">
                          <div className="task-card-left">{p.title}</div>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="18"
                            height="18"
                        ...
                        <div className="task-card-tags-wrapper">
                          {p.tags.map((tag) => (
                            <div className="task-card-tag-wrapper">{tag}</div>
                          ))}
                        </div>
                        ...
                        <div className="task-card-assigned-to-wrapper">
                          {p.assignedToName ? (
                            <div
                              onClick={(event) => handleClick(p._id, event)}
                              className="task-card-assigned-to cbdc"
                            >
                              {p.assignedToName[0].toUpperCase()}
                            </div>
                          ) : (
              ...
              <div className="text-color-grey kanban-board-wrapper">
                <div className="kanban-board-title kanban-title-green">
                  <p className="padding-10px font-size-15px">DONE</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
