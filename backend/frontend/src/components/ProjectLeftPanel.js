    ...
    <div className="project-page-left-panel">
      <div>
        ...
        <div
          className={
            type === 2
              ? "display-flex project-left-panel-items-wrapper project-left-panel-item-selected left-panel-bg-highlight"
              : "display-flex project-left-panel-items-wrapper project-left-panel-item-selected "
          }
        ...
        <div className="display-flex project-left-panel-items-wrapper">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
